...
object InternalDependencies {
  ...
  val data =
    ...
    nullaway = { module = "com.uber.nullaway:nullaway", version = "0.13.4", type = "maven", url = "https://mirrors.cloud.tencent.com/nexus/repository/maven-public/com/uber/nullaway/nullaway/maven-metadata.xml" }
    ...
    # NPM dependencies
    prettier = { module = "prettier", version = "3.8.3", type = "npm", url = "https://registry.npmjs.org/prettier" }
