...
object InternalDependencies {
  ...
  val data =
    ...
    [libraries]
    # Maven dependencies
    junitBom = { module = "org.junit:junit-bom", version = "6.1.1", type = "maven", url = "https://mirrors.cloud.tencent.com/nexus/repository/maven-public/org/junit/junit-bom/maven-metadata.xml" }
    ...
    nullaway = { module = "com.uber.nullaway:nullaway", version = "0.13.7", type = "maven", url = "https://mirrors.cloud.tencent.com/nexus/repository/maven-public/com/uber/nullaway/nullaway/maven-metadata.xml" }
    ...
    # NPM dependencies
    prettier = { module = "prettier", version = "3.9.4", type = "npm", url = "https://registry.npmjs.org/prettier" }
