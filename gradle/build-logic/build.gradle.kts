...
// TODO remove it
configurations.configureEach { resolutionStrategy { force("org.projectlombok:lombok:1.18.44") } }

dependencies {
  implementation("org.jetbrains.kotlinx:kotlinx-coroutines-bom:1.11.0-rc01")
